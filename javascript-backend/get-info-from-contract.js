...
contract.methods.totalSupply().call((err, result) => {
  console.log("OMG totalSupply: ", result);
});

contract.methods.name().call((err, result) => {
  console.log("OMG name: ", result);
});

contract.methods.symbol().call((err, result) => {
  console.log("OMG symbol: ", result);
});

contract.methods.balanceOf(addressOMG).call((err, result) => {
  console.log("OMG rich user balance: ", result);
});
